...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{Examplesignalsegmentfromthe200packetgeneratedfile.png} 
	\captionof{figure}{Example of AFSK signal in the 200 packet generated file.}
\end{Figure}
...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{ExampleSignalSegmentfromtheGeneratedFilewithNoise.png} 
	\captionof{figure}{Example of a generated AFSK signal with artificial white noise added.}
\end{Figure}
...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{ExampleSignalSegmentfromtheLosAngelesRecording.png} 
	\captionof{figure}{Example of AFSK signal in the Los Angeles Recording Test File.}
\end{Figure}

%Well, this hasn't been implmented yet...
