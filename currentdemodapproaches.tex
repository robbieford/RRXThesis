...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{Kantronics-KAM-Plus.jpg} 
	\captionof{figure}{Image of the Kantronics Kam Plus \cite{KK6RF}}
\end{Figure}
...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{Ot3m-termblk.jpg} 
	\captionof{figure}{Image of Argent Data's Open Tracker 3. \cite{Data}}
\end{Figure}
...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{FTM-350US_F.jpg} 
	\captionof{figure}{Image of the FTM-350 Radio which has APRS integrated. \cite{Yaesua}}
\end{Figure}
