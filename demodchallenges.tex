...
\begin{figure}
  \centering
	...
	\caption{An example Bell 202 signal with white noise added. The additional zero crossings at sample 9 in the first bit period and sample 169 in the last bit period will make these 1200Hz bit periods look more like 2200Hz signals.}
   \label{noiseExample}
\end{figure}
