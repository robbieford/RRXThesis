...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{EffectsofaDCOffsetonaSignal.png} 
	\captionof{figure}{An Example Bell 202 signal with a DC offset Problem.}
\end{Figure}
...
\begin{Figure}
  \centering
	\includegraphics[width=0.75\linewidth]{EffectsofDeemphasisonaSignalthatwasnotpreemphasized.png} 
	\captionof{figure}{An Example signal that was deemphasized, but not preemphasized.}
\end{Figure}
