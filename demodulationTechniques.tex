...
\begin{table}
	\begin{center}
		...
		\hline
			Device & OpenTracker2 & OpenTracker3 & Kantronics Kam & MFJ-1278 & PK-88 & PK-232 \\ \hline
			Demodulation Technique & PLL using XR-2211 Chip & Software time delay correlation & Edge detection using TCM3105 Chip & PLL using XR-2211 & Digital filters using AMD 7910 chip & Analog filters \\ \hline
		\end{tabular}
